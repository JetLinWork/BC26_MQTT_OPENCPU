...
typedef enum {
	...
	URC_MQTT_RECV,              //Indication for MQTT RECV event
	URC_MQTT_OPEN,              //Indication for MQTT OPEN event
	URC_MQTT_CONN,              //Indication for MQTT CONN event
    URC_MQTT_SUB,               //Indication for MQTT SUB event
    URC_SYS_END = 100,
    /*****************************************/
